...
This Skill helps you create well-structured Agent Skills that follow best practices and validation requirements.
...
**Personal Skills** (agent-specific user skills directory):
- Individual workflows and preferences
- Experimental Skills
- Personal productivity tools

**Project Skills** (`.claude/skills/`, `.cursor/skills/`, or similar):
...
1. **Reload your agent** to pick up the new Skill
